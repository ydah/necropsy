...
module Necropsy
  class AstScanner
    # Owns syntax-level Ruby facts while the scanner coordinates traversal.
    class RubySemantics
      def initialize(state:, record_semantic_blocker:)
        @state = state
        @record_semantic_blocker = record_semantic_blocker
      end
