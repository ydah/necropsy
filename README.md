...
decisions, and frozen review records. The [0.4.0 migration guide](docs/migrations/0.4.0.md)
describes the actionability-aware CI and removal workflow changes.
